...
import 'package:bingo/home_entergame.dart';
import 'package:bingo/profile.dart';
import 'package:bingo/setting.dart';
import 'package:flutter/material.dart';

class HomeNoSlot extends StatefulWidget {
  const HomeNoSlot({super.key});

  @override
  State<HomeNoSlot> createState() => _HomeNoSlotState();
}

class _HomeNoSlotState extends State<HomeNoSlot> {
  @override
